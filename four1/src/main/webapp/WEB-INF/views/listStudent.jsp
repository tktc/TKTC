...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/bootstrap-3.3.7-dist/js/jquery-3.3.1.min.js"></script>
...
%>--%>
<%--<sping:eval expression="student.discount"/><br/>
${student.discount}<br/>
${student.name}<br/>
${student.pwd}<br/>
${student.age}--%>
...
<%--<table class="table table-striped">
    ...
    <c:forEach items="${students}" var="student">
        <tr>
            ...
            <td>${student.image}</td>
            <td><a href="${pageContext.request.contextPath}/delete.do?id=${student.id}">删除</a></td>
        ...
        <tr>
            ...
            <td>
                <c:forEach items="${student.scores}" var="sc">
                    <c:out value="${sc.course.name}"/>
                    <c:out value="${sc.score}"/>
                </c:forEach>
            </td>
            <td>
